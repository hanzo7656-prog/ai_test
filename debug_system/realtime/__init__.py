...
# ایجاد نمونه‌های real-time با Dependency Injection
console_stream = ConsoleStreamManager(debug_manager, metrics_collector)
live_dashboard = LiveDashboardManager(metrics_collector, alert_manager)
websocket_manager = WebSocketManager(debug_manager, alert_manager)

def initialize_realtime_system():
    """راه‌اندازی و ارتباط سیستم‌های real-time"""
    try:
        # راه‌اندازی سیستم real-time
        logger.info("✅ Real-time system initialized with dependency injection")
