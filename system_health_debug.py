...
class SystemHealthDebugManager:
    ...
    def get_realtime_dashboard(self) -> Dict[str, Union[str, int, float, Dict, List]]:
    ...
    def _get_live_system_metrics(self) -> Dict[str, Dict[str, Union[str, float, int]]]:
    ...
    def _get_live_api_metrics(self) -> Dict[str, Union[int, float]]:
    ...
    def _get_live_ai_metrics(self) -> Dict[str, Union[bool, int, str]]:
    ...
    async def run_auto_health_tests(self) -> Dict[str, Union[str, bool, float, Dict, List]]:
    ...
    async def _test_api_endpoints(self) -> Dict[str, Union[str, int, float, List[Dict[str, Union[str, float, bool, None]]]]]:
    ...
    async def _test_load_capacity(self) -> Dict[str, Union[str, int, float, List[Dict[str, Union[str, float, int, bool]]]]]:
        """تست ظرفیت بار سیستم"""
        try:
            import asyncio
    ...
    def _get_cache_metrics(self) -> Dict[str, Union[float, int]]:
        """دریافت متریک‌های کش"""
    ...
    def log_error(self, error_type: str, message: str, stack_trace: str,
                 context: Dict[str, Union[str, int, float, bool, Dict, List, None]] = None):
        """ثبت خطا"""
        error_entry = {
            'timestamp': datetime.now().isoformat(),
    ...
    def get_system_health(self) -> Dict[str, Union[str, float, List, Dict]]:
        """دریافت سلامت سیستم"""
        return {
            'timestamp': datetime.now().isoformat(),
    ...
    def get_detailed_debug_info(self) -> Dict[str, Union[Dict, List, str]]:
    ...
    def _analyze_errors(self) -> Dict[str, Union[int, Dict[str, int], tuple, str, None]]:
        """تحلیل خطاها"""
    ...
    def _analyze_performance(self) -> Dict[str, Union[str, float, None]]:
        """تحلیل عملکرد"""
