...
try:
    ...
    DEBUG_SYSTEM_AVAILABLE = debug_manager.is_active() if hasattr(debug_manager, 'is_active') else True
    logger.info("✅ Debug system available")
except ImportError:
    DEBUG_SYSTEM_AVAILABLE = False
    logger.warning("⚠️ Debug system not available")
# ایمپورت هوش مصنوعی
try:
